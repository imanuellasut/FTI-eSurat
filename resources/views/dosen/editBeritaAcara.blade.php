...
@section('content')
    <div class="main-card mb-3 card">
        <div class="card-body"><h5 class="card-title">Form Berita Acara</h5>
            <form class="" action="{{ url('dosen/surat-keluar/update-berita-acara', $surat->id) }}" method="POST">
                @csrf
                <!--Hidden Inputan -->
                ...
                <div class="position-relative form-group">
                    ...
                    <input name="tema" id="tema" placeholder="Tema Acara" type="text" class="form-control" value="{{ $surat->tema }}">
                </div>
                <div class="position-relative form-group">
                    <label for="nama_mitra" class="">Mitra</label>
                    <input name="nama_mitra" id="mitra" placeholder="Mitra" type="text" class="form-control" value="{{ $surat->nama_mitra }}">
                </div>
                <div class="form-row">
                    <div class="col-md-2">
                        <div class="position-relative form-group">
                            <label for="waktu_pelaksanaan" class="">Jam</label>
                            <input name="waktu_pelaksanaan" id="waktu_pelaksanaan" placeholder="waktu_pelaksanaan" type="time" class="form-control" value="{{ $surat->waktu_pelaksanaan }}">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="position-relative form-group">
                            <label for="tgl_pelaksanaan" class="">Tanggal</label>
                            <input name="tgl_pelaksanaan" id="tgl_pelaksanaan" placeholder="tgl_pelaksanaana" type="date" class="form-control" value="{{ $surat->tgl_pelaksanaan }}">
                        </div>
                    </div>
                    <div class="col-md-8">
                        <div class="position-relative form-group">
                ...
                <div class="position-relative form-group">
                    ...
                    <textarea name="isi_surat" id="isi_surat" class="form-control">{{ $surat->isi_surat }}</textarea>
                </div>
                <div class="position-relative form-group">
